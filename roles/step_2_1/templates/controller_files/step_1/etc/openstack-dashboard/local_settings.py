...
# The absolute path to the directory where message templates are collected.
# The message file must have a .json file extension. When the user logins to
# horizon, the message templates collected are processed and displayed to the user.
#MESSAGES_PATH=None
...
CACHES = {
    'default': {
        ...
        'LOCATION': '{{ controller_management_ip }}:11211',
    },
}
...
OPENSTACK_HOST = "{{ controller_management_ip }}"
...
# policy rule templates. The content of these templates should match the templates the
# OpenStack services are using to determine role based access control in the
# target installation.

# Path to directory containing policy.json templates
#POLICY_FILES_PATH = os.path.join(ROOT_PATH, "conf")

# Map of local copy of service policy templates.
...
# Having matching policy templates on the Horizon and Keystone servers is essential
# for normal operation. This holds true for all services and their policy templates.
#POLICY_FILES = {
...
# a key, label and static directory containing two templates:
